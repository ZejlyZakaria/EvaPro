<template>
    <div>
        <div class="card shadow mb-4">
            <div class="card-header py-3" style="background-color: #BB5BFF;">
                <h5 class="m-0 font-weight-bold text-white">
                    All providers
                </h5>
            </div>
            <div class="row mt-3 ml-4 mr-4 d-flex justify-content-between">
                <input
                    type="text"
                    class="form-control bg-light border-2 small col-md-4"
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover">
                        <tbody>
                            ...
                            <!-- remove .data from loadusers and added it here in users.data -->
