<template>
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Suivi des paiements</h4>
            <div
                        ...
                        <table class="table">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>Client</th>
                                    <th>Fournisseur</th>
                                    <th>Balance antérieur</th>
                                    <th>Balance finale </th>
                                    <th>Gain / Marge Totale</th>
                                </tr>
                            </thead>
                            <tbody>
                                    <tr
                                        v-for="billing in tempBillings"
                                        :id="'trow' + billing.id"
                                        v-bind:data-target="
                                            '#billing' + billing.id
                                        "
                                    ...
                                    >
                                        ...
                                        <td v-if="(billing.all_total_paid_per_client - billing.all_total_paid - billing.total_commissions) < 0" class="bg-danger" style="font-weight: 600; text-align: center; font-size: 1rem; border-left: 2px solid #fff  ">
                                            Déficit
                                        </td>
                                        <td v-if="(billing.all_total_paid_per_client - billing.all_total_paid - billing.total_commissions) > 0" class="bg-success" style="font-weight: 600; text-align: center; font-size: 1rem; border-left: 2px solid #fff  ">
                                            Excédent
                                        </td>
                                        <td v-if="(billing.all_total_paid_per_client - billing.all_total_paid - billing.total_commissions) == 0" style="font-weight: 600; text-align: center; font-size: 1rem; border-left: 2px solid #fff  ">
                                            A jour
                                        </td>
                                        <td class="bg-info" style="font-weight: 600; text-align: center; font-size: 1rem; border-left: 2px solid #fff  ">
                                            {{ (billing.all_total_paid_per_client - billing.all_total_paid - billing.total_commissions) + " €" }}
                                        </td>
                                        <td style="font-weight: 600; background-color: #46c35f; text-align: center; font-size: 1rem; border-left: 2px solid #fff ">
    ...
    methods: {
        ...
        fillInputsYear() {
            ...
            for (var Y = nowY; Y >= 2000; Y--) {
                options += "<option style='font-size: 0.9rem; font-weight: 600'>" + Y + "</option>";
            }
